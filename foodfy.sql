...
8	Olena Sergienko	https://images.unsplash.com/photo-1557053910-d9eadeed1c58?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80	2020-03-16 00:00:00
...
9	2	Camarão à Moda Baiana	https://img.itdg.com.br/tdg/images/recipes/000/000/031/38709/38709_original.jpg?mode=crop&width=710&height=400	{"1 kg de camarões","Sal, pimenta limão, cheiro verde ao seu gosto","1 kg de tomates (sem pele e sem sementes)","2 colheres de sopa de óleo de soja","2 ou 3 colheres de sopa de azeite de dendê","Leite de coco"}	{"Limpe os camarões, retirando as cascas e as tripas, e lavando-os a seguir. ","Tempere com sal, pimenta, suco de limão e cheiros-verdes. ","Leve ao fogo uma panela com um pouco de óleo. Quando o o óleo estiver quente, coloque os camarões e deixe dourar bem, junte os tomates formando um molho bem consistente. ","Acrescente o leite de coco, e deixe no fogo com panela bem tapada, por mais 10 minutos.","Por fim, junte o azeite de dendê. Pimenta a gosto."}	 	2020-03-16 00:00:00
\.
...
SELECT pg_catalog.setval('public.chefs_id_seq', 8, true);
